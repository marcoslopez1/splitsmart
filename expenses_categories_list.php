  ...
  <section id="container">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              ...
              <li class="active"><a href="expenses_categories_list.php">List of categories</a></li>
    ...
    <section id="main-content">
      <section class="wrapper">
        ...
        <h2 class="centered">List of active categories</h2>
          ...
          <div class="col-md-10 col-md-offset-1 mt mb">
            <div class="accordion" id="accordion2">
              ...
              <?php if(!empty($items)): ?>
                          ...
                          <div class="accordion-inner">
                            <p>
                              ...
                              if (!empty($item['start_date'])):
                                echo '</br><strong>Event start date: </strong>'.$item['start_date'];
                              endif;
                              if (!empty($item['finish_date'])):
                                echo '</br><strong>Event finish date: </strong>'.$item['finish_date'];
                              endif;
                              ?>
                          </p>
                        </div>
                ...
                <?php endforeach; ?>
            <?php else: ?>
              <p>You haven't added any category yet. Go to <a href=expenses_categories_new.php>Create new category</a> page to start.</p>
            <?php endif; ?>
