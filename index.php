  ...
  <section id="container">
    ...
    <section id="main-content">
      <section class="wrapper">
        ...
        <h1 class="centered">Welcome to </br>SplitSmart</h1>
        <h5 class="centered">An easy way to split your payments among your peers</h5>
        </br></br>
        <div class="row">
          <div class="col-sm-4"><a href="events_list.php"><h4 class="centered"><i class="fa fa-folder"></i> view events</h4></a></div>
          <div class="col-sm-4"><a href="events_new.php"><h4 class="centered"><i class="fa fa-plus"></i> create event</h4></a></div>
          <div class="col-sm-4"><a href="expenses_new.php"><h4 class="centered"><i class="fa fa-plus"></i> add expense</h4></a></div>
        </div>
        <br><br><br><br>
