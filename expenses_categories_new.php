  ...
  <section id="container">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              ...
              <li class="active"><a href="expenses_categories_new.php">Create new category</a></li>
            </ul>
          </li>
        </ul>
        <!-- sidebar menu end-->
    ...
    <section id="main-content">
      <section class="wrapper">
        ...
        <h2 class="centered">Create a new category</h2>
        <div class="row mt">
          <div class="col-lg-12">
            <div class="form-panel">
            </br>
              <form class="form-horizontal style-form" method="post" action="includes/new_category.inc.php">
    ...
    if(isset($_GET['action'])){
        ...
        $(document).ready(function() {
          var unique_id = $.gritter.add({
            ...
            text: "Go to Llist of categories page to see the list of active categories.",
