...
$itemsQuery = $db->prepare("
  SELECT id, amount, name, description, category, date, made_by, event, creation_date_stamp
  FROM expenses
  ...
  <section id="container">
      ...
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              <li class="active"><a href="expenses_list.php">List of expenses</a></li>
    ...
    <section id="main-content">
      <section class="wrapper">
        ...
        <h2 class="centered">List of expenses</h2>
        <div class="row content-panel">
          ...
          <div class="col-md-10 col-md-offset-1 mt mb">
            <div class="accordion" id="accordion2">
                        ...
                        <div id="<?php echo 'collapse'.$item['id'];?>" class="accordion-body collapse">
                          <div class="accordion-inner">
                            <p>
                              ...
                              if (!empty($item['date'])):
                                echo '</br><strong>Made on date: </strong>'.$item['date'];
                              endif;
                              if (!empty($item['category'])):
                                echo '</br><strong>Category: </strong>'.$item['category'];
                              endif;
                              ?>
                          </p>
                        </div>
                ...
                <?php endforeach; ?>
              <?php else: ?>
              <p>You haven't added any expense yet. Go to <a href=expenses_new.php>Create new expense</a> page to start.</p>
              <?php endif; ?>
            </div>
          </div>
        </div>
