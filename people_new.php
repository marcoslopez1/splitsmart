  ...
  <section id="container">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              ...
              <li class="active"><a href="people_new.php">Create new person</a></li>
            </ul>
          </li>
          <li class="sub-menu">
            <a class="" href="">
    ...
    <section id="main-content">
      <section class="wrapper">
        ...
        <h2 class="centered">Create a new person</h2>
        <div class="row mt">
          <div class="col-lg-12">
            <div class="form-panel">
            </br>
              <form class="form-horizontal style-form" method="post" action="includes/new_people.inc.php">
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">Name:</label>
                  <div class="col-sm-10">
                    <input class="form-control" name="name" id="focusedInput" type="text" placeholder="Enter a name" required>
                  </div>
                  </br></br>
    ...
    if(isset($_GET['action'])){
        ...
        $(document).ready(function() {
          var unique_id = $.gritter.add({
            ...
            title: "The person has been created!",
            // (string | mandatory) the text inside the notification
            text: "Go to Llist of people page to see the list of active contributors.",
