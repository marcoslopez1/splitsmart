  ...
  <section id="container">
      ...
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              <li class="active"><a href="people_list.php">List of people</a></li>
    ...
    <section id="main-content">
      <section class="wrapper">
        ...
        <h2 class="centered">List of active people</h2>
          ...
          <div class="col-md-10 col-md-offset-1 mt mb">
            <div class="accordion" id="accordion2">
              ...
              <?php if(!empty($items)): ?>
                ...
                <?php endforeach; ?>
            <?php else: ?>
              <p>You haven't added any person yet. Go to <a href=people_new.php>Create new person</a> page to start.</p>
            <?php endif; ?>
